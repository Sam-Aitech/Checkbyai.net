    ...
    >
      <defs>
        <linearGradient id="shm-lg" x1="4" y1="4" x2="28" y2="28" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--icon-brand-start)" />
          <stop offset="1" stopColor="var(--icon-brand-end)" />
        </linearGradient>
        <radialGradient id="shm-rg" cx="16" cy="11" r="13" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--icon-brand-soft)" stopOpacity="0.45" />
          <stop offset="1" stopColor="var(--icon-brand-end)" stopOpacity="0" />
        </radialGradient>
      ...
      {/* End indicator dots */}
      <circle cx="8.5" cy="16.5" r="1.6" fill="var(--icon-brand-soft)" />
      <circle cx="23.5" cy="16.5" r="1.6" fill="var(--icon-brand-soft)" />
    </svg>
  );
}
    ...
    >
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-success-start)" />
          <stop offset="100%" stopColor="var(--icon-success-end)" />
        </linearGradient>
      </defs>
      {/* Bell body */}
      <path
      ...
      />
      {/* Bell top stem */}
      <line x1="12" y1="3" x2="12" y2="9" stroke="var(--icon-success-soft)" strokeWidth="1.5" strokeLinecap="round" />
      {/* Bell clapper base */}
      <path
        d="M9.5 18a2.5 2.5 0 0 0 5 0"
        stroke="var(--icon-success-soft)"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
      />
      {/* Badge dot with lightning bolt */}
      <circle cx="18.5" cy="6" r="4" fill="var(--icon-success-end)" />
      <path
    ...
    >
      <defs>
        <linearGradient id="dv-doc" x1="4" y1="2" x2="28" y2="30" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--icon-violet-start)" />
          <stop offset="1" stopColor="var(--icon-violet-end)" />
        </linearGradient>
        <linearGradient id="dv-badge" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop stopColor="var(--icon-success-vivid)" />
          <stop offset="1" stopColor="var(--icon-success-deep)" />
        </linearGradient>
      ...
      <polyline
        ...
        stroke="var(--icon-violet-start)"
        strokeWidth="1.5"
        strokeLinejoin="round"
        fill="none"
      />
      {/* Document content lines */}
      <line x1="9" y1="14" x2="18" y2="14" stroke="var(--icon-violet-soft)" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="9" y1="18" x2="16" y2="18" stroke="var(--icon-violet-soft)" strokeWidth="1.3" strokeLinecap="round" opacity="0.65" />
      <line x1="9" y1="22" x2="13" y2="22" stroke="var(--icon-violet-soft)" strokeWidth="1" strokeLinecap="round" opacity="0.35" />

      {/* Badge backing (dark circle for contrast) */}
      <circle cx="23" cy="23" r="7.5" fill="var(--icon-ink)" />
...
export function TimelineClockIcon({ className = '', size = 24 }: IconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-danger-start)" />
          <stop offset="100%" stopColor="var(--icon-danger-end)" />
        </linearGradient>
      </defs>
      ...
      <rect
        ...
        strokeWidth="1.2"
      />
      <line x1="3" y1="8" x2="15" y2="8" stroke="var(--icon-danger-soft)" strokeWidth="1" opacity="0.5" />
      <line x1="7" y1="5" x2="7" y2="3" stroke="var(--icon-danger-soft)" strokeWidth="1.2" strokeLinecap="round" />
      <line x1="11" y1="5" x2="11" y2="3" stroke="var(--icon-danger-soft)" strokeWidth="1.2" strokeLinecap="round" />
      ...
      <line x1="15.5" y1="15.5" x2="15.5" y2="11.5" stroke="var(--icon-danger-start)" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="15.5" y1="15.5" x2="18.2" y2="15.5" stroke="var(--icon-danger-start)" strokeWidth="1.2" strokeLinecap="round" />
      <circle cx="15.5" cy="15.5" r="0.8" fill="var(--icon-danger-start)" />
    </svg>
  );
}
...
export function EarlyWarningIcon({ className = '', size = 24 }: IconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-warning-start)" />
          <stop offset="100%" stopColor="var(--icon-warning-end)" />
        </linearGradient>
      </defs>
      {/* Magnifying glass */}
      <circle
        ...
        strokeWidth="1.5"
      />
      <line x1="16.5" y1="16.5" x2="21" y2="21" stroke="var(--icon-warning-soft)" strokeWidth="2" strokeLinecap="round" />
      {/* Warning triangle inside lens */}
      <path
        d="M11 7L14.5 13.5H7.5L11 7Z"
        fill={`url(#${id})`}
        opacity="0.4"
        stroke="var(--icon-warning-soft)"
        strokeWidth="1.2"
        strokeLinejoin="round"
      />
      {/* Exclamation in triangle */}
      <line x1="11" y1="9.5" x2="11" y2="11.5" stroke="var(--icon-warning-soft)" strokeWidth="1.2" strokeLinecap="round" />
      <circle cx="11" cy="12.8" r="0.5" fill="var(--icon-warning-soft)" />
    </svg>
  );
}
    ...
    >
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="var(--icon-teal-start)" />
          <stop offset="100%" stopColor="var(--icon-teal-end)" />
        </linearGradient>
      </defs>
      {/* Center source dot */}
    ...
    >
      <defs>
        <linearGradient id="ukl-body" x1="5" y1="14" x2="27" y2="30" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--icon-info-start)" />
          <stop offset="1" stopColor="var(--icon-info-end)" />
        </linearGradient>
      ...
      {/* Lock body */}
      <rect x="5" y="15" width="22" height="15" rx="3.5" fill="url(#ukl-body)" stroke="var(--icon-info-soft)" strokeWidth="1.5" />
...
export function VerifiedStampIcon({ className = '', size = 24 }: IconProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="12" cy="12" r="7" stroke="var(--icon-success-soft)" strokeWidth="1" strokeDasharray="2 2" fill="none" />
      <polyline
        points="8,12 11,15 16,9"
        stroke="var(--icon-success-start)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
        fill="none"
...
export function CreditCoinIcon({ className = '', size = 16 }: IconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-info-soft)" />
          <stop offset="100%" stopColor="var(--icon-info-start)" />
        </linearGradient>
      </defs>
      <circle cx="8" cy="8" r="7" fill={`url(#${id})`} opacity="0.2" stroke={`url(#${id})`} strokeWidth="1" />
      <circle cx="8" cy="8" r="4.5" stroke="var(--icon-info-soft)" strokeWidth="0.8" fill="none" />
      <text
        x="8"
        y="11.2"
        textAnchor="middle"
...
export function HeroAlertIcon({ className = '', size = 20 }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-danger-soft)" />
          <stop offset="100%" stopColor="var(--icon-danger-start)" />
        </linearGradient>
      ...
      <line x1="8" y1="4" x2="8" y2="7" stroke="var(--icon-danger-soft)" strokeWidth="2" strokeLinecap="round" />
      <line x1="16" y1="4" x2="16" y2="7" stroke="var(--icon-danger-soft)" strokeWidth="2" strokeLinecap="round" />
      <line x1="5" y1="10" x2="19" y2="10" stroke="var(--icon-danger-soft)" strokeWidth="1.5" opacity="0.7" />
      
      {/* Intense Glowing Clock overlay */}
      <circle cx="16" cy="16" r="6" fill="var(--icon-ink)" stroke="var(--icon-danger-soft)" strokeWidth="1.5" />
      <line x1="16" y1="16" x2="16" y2="13" stroke="var(--icon-danger-soft)" strokeWidth="2" strokeLinecap="round" />
      <line x1="16" y1="16" x2="18.5" y2="16" stroke="var(--icon-danger-soft)" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="16" cy="16" r="1" fill="var(--icon-danger-soft)" filter="url(#hero-alert-glow)"/>
    </svg>
  );
}
...
export function HeroTrackedIcon({ className = '', size = 20 }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-brand-start)" />
          <stop offset="100%" stopColor="var(--icon-brand-deep)" />
        </linearGradient>
      ...
      <path d="M12 3L4 6.5V11c0 5.5 3.5 10 8 11.5c4.5-1.5 8-6 8-11.5V6.5L12 3Z" fill="url(#hero-track-grad)" opacity="0.3" stroke="var(--icon-brand-start)" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M12 3L4 6.5V11c0 5.5 3.5 10 8 11.5c4.5-1.5 8-6 8-11.5V6.5L12 3Z" stroke="var(--icon-brand-start)" strokeWidth="0.5" strokeLinejoin="round" filter="url(#hero-track-glow)" opacity="0.5" />

      {/* Intense Glowing Pulse Line */}
      <polyline points="6,12 8,12 9.5,8.5 11.5,15.5 13,10.5 14.5,12 18,12" stroke="var(--icon-brand-soft)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" filter="url(#hero-track-glow)"/>
      <circle cx="6" cy="12" r="1.5" fill="var(--icon-brand-soft)" />
      <circle cx="18" cy="12" r="1.5" fill="var(--icon-brand-soft)" />
    </svg>
  );
}
...
export function HeroGDPRLockIcon({ className = '', size = 20 }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--icon-info-start)" />
          <stop offset="100%" stopColor="var(--icon-info-deep)" />
        </linearGradient>
      ...
      <rect x="5.5" y="11" width="13" height="10" rx="3" fill="url(#hero-gdpr-grad)" stroke="var(--icon-info-soft)" strokeWidth="1.5" opacity="0.8" />
      <rect x="6.5" y="12" width="11" height="8" rx="2" fill="none" stroke="var(--icon-info-soft)" strokeWidth="0.5" opacity="0.5" />
      
      {/* Shackle */}
      <path d="M8 11V7a4 4 0 0 1 8 0v4" stroke="var(--icon-info-soft)" strokeWidth="2.5" strokeLinecap="round" fill="none" filter="url(#hero-gdpr-glow)"/>
      
      {/* Glowing Keyhole */}
      <circle cx="12" cy="15" r="1.8" fill="#ffffff" filter="url(#hero-gdpr-glow)" />
      <rect x="11.2" y="15" width="1.6" height="3" rx="0.5" fill="#ffffff" filter="url(#hero-gdpr-glow)" />
      
      {/* Red cross detail (UK cue) */}
      <line x1="5.5" y1="16" x2="8" y2="16" stroke="var(--icon-danger-soft)" strokeWidth="1.5" opacity="0.9" strokeLinecap="round" />
      <line x1="16" y1="16" x2="18.5" y2="16" stroke="var(--icon-danger-soft)" strokeWidth="1.5" opacity="0.9" strokeLinecap="round" />
    </svg>
  );
}
