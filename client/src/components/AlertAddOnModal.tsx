...
const ANNUAL_PLANS = [
  ...
  { packageType: 'alert_annual_pro', name: 'Alert Pass Pro (Annual)', price: '£19.99', period: '/yr', description: `Up to 5 companies, ${ALERT_TIMING_SHORT.pro.toLowerCase()} + SMS`, icon: Zap },
] as const;
