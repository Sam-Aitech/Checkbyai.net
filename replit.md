...
- **Sponsor Licence Monitor**: Tracks changes in the UK Home Office Register of Licensed Sponsors, with features for company name matching and duplicate handling. Database tables: `sponsor_list`, `company_watches`, `sponsor_changes`, `notification_preferences`, `notification_log`. Watch limits: free=1, starter=5, pro=20, unlimited=-1, enterprise=-1.
