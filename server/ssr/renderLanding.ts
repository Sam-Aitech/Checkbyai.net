...
<div class="ssr-landing">
  <nav style="display:flex;align-items:center;justify-content:space-between;padding:1rem 1.5rem;max-width:80rem;margin:0 auto;">
    <a href="/" style="font-weight:700;font-size:1.25rem;color:var(--foreground);text-decoration:none;">
      <span style="color:var(--primary);">Check</span>ByAI
    </a>
  ...
  <section style="max-width:80rem;margin:4rem auto;padding:0 1.5rem;text-align:center;">
    <h1 style="font-size:clamp(2rem,5vw,3.5rem);font-weight:800;color:var(--foreground);line-height:1.15;margin-bottom:1.5rem;">
      Never Miss a <span style="color:var(--primary);">Sponsor Licence</span> Revocation Again
    </h1>
    <p style="font-size:1.125rem;color:var(--muted-foreground);max-width:640px;margin:0 auto 2.5rem;line-height:1.6;">
    ...
    <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;">
      <a href="/sponsor-monitor" style="display:inline-flex;align-items:center;padding:0.875rem 2rem;background:var(--primary);color:var(--primary-foreground);border-radius:999px;text-decoration:none;font-weight:600;font-size:1rem;">
        Monitor a Sponsor
        <span style="margin-left:0.5rem;">&rarr;</span>
      </a>
      <a href="/sponsors" style="display:inline-flex;align-items:center;padding:0.875rem 2rem;border:1px solid var(--border);color:var(--foreground);border-radius:999px;text-decoration:none;font-weight:600;font-size:1rem;background:var(--card);">
        Browse Register
      </a>
    </div>
  </section>
  ...
  <section style="max-width:80rem;margin:0 auto;padding:3rem 1.5rem;">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1.5rem;text-align:center;">
      <div style="padding:2rem;background:var(--muted);border-radius:0.75rem;">
        <div style="font-size:2rem;font-weight:800;color:var(--primary);margin-bottom:0.5rem;">99.9%</div>
        <div style="color:var(--muted-foreground);font-size:0.875rem;">Uptime Monitoring</div>
      </div>
      <div style="padding:2rem;background:var(--muted);border-radius:0.75rem;">
        <div style="font-size:2rem;font-weight:800;color:var(--primary);margin-bottom:0.5rem;">4</div>
        <div style="color:var(--muted-foreground);font-size:0.875rem;">Alert Channels</div>
      </div>
      <div style="padding:2rem;background:var(--muted);border-radius:0.75rem;">
        <div style="font-size:2rem;font-weight:800;color:var(--primary);margin-bottom:0.5rem;">Instant</div>
        <div style="color:var(--muted-foreground);font-size:0.875rem;">Revocation Alerts</div>
      </div>
      <div style="padding:2rem;background:var(--muted);border-radius:0.75rem;">
        <div style="font-size:2rem;font-weight:800;color:var(--primary);margin-bottom:0.5rem;">24/7</div>
        <div style="color:var(--muted-foreground);font-size:0.875rem;">Register Scanning</div>
      </div>
    </div>
  </section>
  ...
  <section style="max-width:80rem;margin:0 auto;padding:4rem 1.5rem;text-align:center;">
    <h2 style="font-size:1.75rem;font-weight:700;color:var(--foreground);margin-bottom:1rem;">Verify a Certificate of Sponsorship</h2>
