 ...
 * (server/utils/sponsorMonitorJob.ts). Pro/Unlimited/Enterprise subscribers
 * get an alert within minutes of that check; Starter subscribers get a
 * same-day digest at 18:00 UTC; Free has no automated alerts.
 */
export const ALERT_TIMING_COPY: Record<PlanTier, string> = {
  free: "Not included on the free plan — check manually anytime",
  starter: "Same-day digest at 18:00 UTC",
  pro: "Instant — within minutes of the ~00:30 UTC nightly check",
  unlimited: "Instant — within minutes of the ~00:30 UTC nightly check",
  enterprise: "Instant — within minutes of the ~00:30 UTC nightly check",
};

/** Short badge/marketing form of the same timing facts, for compact UI. */
export const ALERT_TIMING_SHORT: Record<PlanTier, string> = {
  free: "No alerts",
